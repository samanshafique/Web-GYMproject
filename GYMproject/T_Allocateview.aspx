<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="T_Allocateview.aspx.cs" Inherits="GYMproject.T_Allocateview" %>
...
<body>
    ...
    <li style="background-color:black;color:white;padding: 5px 16px;" href="trainer.aspx">Dashboard</li>
         ...
         <%--  <li><a href="tcategories.aspx">Categories</a></li>--%>
           ...
           <li><a class="active" href="T_Allocateview.aspx">Allocated Members</a></li>
        ...
        <div style="margin-top: 0px;" class="auto-style3">
            ...
            <h2 class="auto-style8">Allocated Members</h2>
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="#5f8eb0" BorderColor="Black" BorderStyle="Groove" CssClass="auto-style7" ForeColor="White" Width="689px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Height="244px">
