<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainerCalender.aspx.cs" Inherits="GYMproject.TrainerCalender" %>
...
<body>
    <form id="form1" runat="server">
         <center><h1 style="background-color:#5f8eb0; height: 44px; margin-top: 0px;">Power House Gym Management System</h1></center>
    ...
    <li style="background-color:black;color:white;padding: 5px 16px;" href="Trainer.aspx">Dashboard</li>
           ...
           <li style="background-color:#5f8eb0;padding: 5px 16px;" href="#about">Programs</li>
             <li><a class="active" href="TrainerCalender.aspx">Calendar</a></li>
        ...
        <div style="margin-top: 0px;" class="auto-style3">
            ...
            <table class="auto-style67">
                ...
                <tr>
                    ...
                    <td class="auto-style68" >                     
                        ...
                        &nbsp;
            <asp:Button class="button2" style="background-color:#80b3cf;color:white;" ID="Button3" runat="server" Text="Update" OnClick="Button3_Click" CssClass="auto-style70" />
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="#5f8eb0" BorderColor="Black" BorderStyle="Groove" CssClass="auto-style7" ForeColor="White" Width="715px" Height="156px" style="margin-top: 0px">
