<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SessionTypes.aspx.cs" Inherits="GYMproject.SessionTypes" %>
...
<body>
  ...
  <li><a href="MemberShipTsype.aspx">Membership Type</a></li>
   ...
   <li><a class="active" href="SessionTypes.aspx">Session Types</a></li>
   <li><a href="WeeklyEvents.aspx">Weekly Events</a></li>
        ...
        <div style="margin-top: 0px;" class="auto-style3">
            ...
            <table class="auto-style1">
                <tr>
                    <td>
                        <strong>
                        <asp:Label ID="Label3" runat="server" Text="Session ID"></asp:Label>
                        </strong>
                        </td>
                    <td>

                        <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
                        <a><asp:Button class="button2" style="background-color:#04AA6D;color:white;" ID="Button4" runat="server" Text="Get" OnClick="Button4_Click" Width="49px" /></a>
