<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberCalender.aspx.cs" Inherits="GYMproject.MemberCalender" %>
...
<body>
    ...
    <li style="background-color:black;color:white;padding: 5px 16px;" href="trainer.aspx">Dashboard</li>
          ...
          <li><a href="M_AllocateView.aspx">Allocated Trainers</a></li>
            ...
            <li><a class="active" href="MemberCalender.aspx">Calendar</a></li>
        ...
        <div style="margin-top: 0px;" class="auto-style3">
            ...
            <h2 class="auto-style6"><strong>Members weekly Calender</strong></h2>
