<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="memberdietplan.aspx.cs" Inherits="GYMproject.memberdietplan" %>
...
<body>
    ...
    <li style="background-color:black;color:white;padding: 5px 16px;" href="trainer.aspx">Dashboard</li>
           ...
           <li><a href="M_AllocateView.aspx">Allocated Trainers</a></li>
            ...
            <li><a class="active"  href="memberdietplan.aspx">Diet plan</a></li>
        ...
        <div style="margin-top: 0px;" class="auto-style3">
            ...
            <h2 class="auto-style10"><strong>Members Diet Plan</strong></h2>
            
            <br />
                              
        </div>
            <asp:GridView ID="GridView1" runat="server" BackColor="#5f8eb0" BorderColor="Black" BorderStyle="Groove" CssClass="auto-style7" ForeColor="White" Width="638px" Height="237px">
